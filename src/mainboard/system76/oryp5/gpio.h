...
static const struct pad_config gpio_table[] = {
		...
		PAD_CFG_TERM_GPO(GPD11, 1, NONE, DEEP),a // LAN_DISABLE#
		...
		PAD_CFG_NF(GPP_A9, NONE, DEEP, NF1), // CLK_PCI_KBC_R
		...
		_PAD_CFG_STRUCT(GPP_B20, 0x42040100, 0x0000), // SMI#_RR
		PAD_CFG_GPI(GPP_B21, UP_20K, DEEP), // NC
		PAD_CFG_GPI(GPP_B22, UP_20K, DEEP), // LPSS_GSPI1_MOSI
		_PAD_CFG_STRUCT(GPP_B23, 0x80880100, 0x3000), // GPP_B23_SML1ALERT (SCI#)
		...
		PAD_CFG_TERM_GPO(GPP_F22, 1, NONE, DEEP), // DGPU_PWR_EN
		PAD_CFG_TERM_GPO(GPP_F23, 1, NONE, DEEP), // DGPU_RST#_PCH
		...
		PAD_CFG_GPI(GPP_H5, NONE, PLTRST), // CLK_REQ12_SSD2#
